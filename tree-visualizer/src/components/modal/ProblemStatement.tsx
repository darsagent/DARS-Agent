      ...
      <div className="flex justify-between" style={{ height: "600px" }}>
        <div className="pb-2 pl-2 pb-8  overflow-y-scroll bg-white">
          <div className="sticky top-0 py-2 bg-white">
            ...
            <Divider flexItem />
            <div className="pl-6 pt-4 text-xl text-gray-500">
          ...
          <div
            className=" mx-6 mt-4 pt-4 border solid rounded-xl border-black pl-8 bg-gray-200 overflow-x-scroll no-scrollbar"
            style={{
              maxWidth: "1100px",
              height: "350px",
            }}
